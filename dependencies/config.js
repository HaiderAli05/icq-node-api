...
module.exports = {
  ...
  MONGO_ATLAS_CONNECTION_URI: `mongodb+srv://${DB_USERNAME}:${DB_PASSWORD}@icqcluster01.fdjg4hv.mongodb.net/${APP_MODE === `PROD` ? `icq-prod` : `icq-dev`}?retryWrites=true&w=majority`,
